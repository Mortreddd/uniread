...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth scroll-p-40">
    ...
    <body>
        <main class="container box-border w-full min-h-full p-0 m-0">
                ...
                @include("components.heading", ['books' => $books,
                ...
                @include("components.section", ['genre' => 'Mystery', 
                                                'books' => $books])
                @include("components.heading", ['bestbook' => $bestbook, 
                ...
                @include("components.heading", ['bestbook' => $bestbook, 
                                                'backgrounds' => 'backgrounds/Teen_FictionBg.svg',
                ...
                @include("components.heading", ['bestbook' => $bestbook, 
                                                'backgrounds' => 'backgrounds/Horror_Thriller.svg',
