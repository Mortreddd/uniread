<div id="followers-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-md max-h-full p-4">
        ...
        <div class="relative bg-white rounded-lg">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t bg-fuchsia-950 md:p-5 dark:border-gray-600">
                <button type="button" class="end-2.5 text-white bg-transparent hover:bg-fuchsia-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="followers-modal">
            ...
            <div class="p-4 md:p-5">
                ...
                <h3 class="text-xl font-semibold text-fuchsia-950 ">
                    Followers of {{ $author->fullname }}
                </h3>   
                    <div class="w-full flex justify-center h-80 flex-wrap overflow-x-hidden overflow-y-auto">
                        
                    
                    @unless($followers->isEmpty())

                        @foreach ($followers as $follower)
                        <a href="{{ route('author.profile', ['id' => $follower->author->id]) }}" class="flex items-center justify-center w-full h-20 mx-1 bg-gray-100 border-2 border-gray-200 border-solid rounded-lg md:justify-normal hover:cursor-pointer md:p-2 hover:bg-gray-300 md:h-24">

                            <img
                                src="{{ asset($follower->author->image) }}"
                                alt=""
