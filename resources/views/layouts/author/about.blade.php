        ...
        <aside id="default-sidebar" class="sticky h-screen transition-transform w-[40vw]" aria-label="Sidebar">
            <div class="h-full p-10 overflow-y-auto ">
                <ul class="space-y-2 font-medium">
                    ...
                    <li class="flex justify-center my-3 border-l-4 border-solid items">
                        <a href="#join-us" class="ml-5 font-sans text-2xl text-black">Join us on this literacy journey</a>
                    </li>
                </ul>
            </div>
        </aside>
