        ...
        <main class="flex w-full">
            <div class="flex w-full tab-content" id="terms-and-conditions">
                ...
                <article class="w-full p-10 mr-5 font-sans text-justify text-gray-600 bg-gray-200 rounded-lg shadow-lg shadow-gray-200">
                    <h2 class="mb-2 text-2xl font-semibold text-gray-900 " id="acceptance-of-terms">Acceptance of Terms</h2>
                    ...
                    <h2 class="my-5 mb-2 text-2xl font-semibold text-gray-900 " id="user-responsibility">User Reponsibility</h2>
                    ...
                    <h2 class="my-5 mb-2 text-2xl font-semibold text-gray-900 " id="user-content">User Content</h2>
                    <ul class="w-full space-y-3 text-gray-500 list-disc list-inside  dark:text-gray-400">
                        <li class='text-xl'>
            ...
            <div class="hidden tab-content my-5 px-20 min-h-[40vh] w-screen flex-col flex items-center" id="privacy-policy">
                <article class="w-full p-10 mr-5 font-sans text-justify text-gray-600 bg-gray-200 rounded-lg shadow-lg shadow-gray-200">
                    ...
                    <h2 class="my-5 mb-2 text-2xl font-semibold text-gray-900 " id="user-content">Update and Changes</h2>
                    <ul class="w-full space-y-3 text-gray-500 list-disc list-inside  dark:text-gray-400">
                        <li class='text-xl'>
                    ...
                    <h2 class="my-5 mb-2 text-2xl font-semibold text-gray-900 " id="user-content">Disclaimers</h2>
                    <ul class="w-full space-y-3 text-gray-500 list-disc list-inside  dark:text-gray-400">
                        <li class='text-xl'>
