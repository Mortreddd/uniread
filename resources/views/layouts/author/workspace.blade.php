...
@section('content')
    ...
    <main class="container mx-auto min-vh-full">
        <div class="flex w-full h-full">
            ...
            <form method="POST" class="w-full mx-10 p-7">
                ...
                <div class="w-full py-3">
                    ...
                    <div class="w-full border-2 border-solid h-fit">
                        <textarea id="content" name="content" placeholder="Write something..." id="" rows="10" class="w-full p-5 overflow-y-scroll text-xl text-black bg-white border border-gray-900 border-none rounded-lg resize-none focus:outline-none focus:ring-0"></textarea>
                    </div>
                </div>
            </form>
        </div>
