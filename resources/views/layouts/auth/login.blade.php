...
@section('content')
            ...
            >
                ...
                @enderror
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            <input id="default-checkbox" type="checkbox" value="" name="remember" class="w-4 h-4 mr-1 bg-transparent border-2 border-solid rounded-md active:outline-fuchsia-950 text-fuchsia-900 border-fuchsia-900 hover:border-fuchsia-950">
                    ...
                    <a
                        href="/register"
                        class="font-sans text-lg text-center text-red-500 hover:text-red-600 hover:cursor-pointer"
                        >Register here</a
                    >
                </form>
        ...
        <div class="relative w-full max-w-md max-h-full p-4">
            ...
            <div class="relative bg-white rounded-lg">
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" action="{{ route('verify.email.process') }}" method="POST">
                        @csrf
                        ...
                        <p class="text-gray-500">
                            ...
                            We'll send you an email with your username and a otp to reset your password.
                        </p>
                        <div>
                            <div class="mb-3">
                                <div
    ...
    @if(Session::has('success'))
        <div id="toast-success" class="bottom-0 right-0 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow ixed dark:text-gray-400 dark:bg-gray-800" role="alert">
            ...
            <div class="text-sm font-normal ms-3">{{ Session::get('success') }}</div>
