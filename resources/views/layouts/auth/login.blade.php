            ...
            >
                ...
                @enderror
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <button type="button" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" class="px-3 font-sans text-sm font-medium bg-transparent text-fuchsia-900 hover:text-fuchsia-950">Forgort Password?</button>
                    </div>
                    <button
                        type="submit"
