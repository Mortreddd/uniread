...
>
    ...
    <body>
        ...
        <main
            class="container box-border flex w-full h-[80vh] p-0 m-0 border-2 border-solid"
        >
            <div class="flex flex-col justify-center min-h-full w-96">
                <h1
            ...
            <img
                class="w-auto h-auto"
                src="{{ asset('backgrounds/Login.svg') }}"
                alt=""
            />
            --}}
        </main>
