    ...
    <div class="relative w-full max-w-md max-h-full rounded-lg bg-fuchsia-900">
        ...
        <div class="flex flex-col p-6 text-center rounded-2xl bg-fuchsia-900">
            ...
            <div class="flex items-center mx-2">
                ...
                <a href="/books/{{ $book->id }}" data-modal-hide="{{ $book->id }}" href="" class="font-sans text-lg text-white hover:text gray-100">Read</a>
            </div>
            <div class="flex items-center mx-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-2 text-white">
                ...
                <a data-modal-hide="{{ $book->id }}" href="" class="font-sans text-lg text-white hover:text gray-100">Info</a>
            </div>
            <form class="flex items-center mx-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-2 text-white">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5m8.25 3v6.75m0 0l-3-3m3 3l3-3M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z" />
                  </svg>
                  
                <a data-modal-hide="{{ $book->id }}" href="" class="font-sans text-lg text-white hover:text gray-100">Archive Story</a>
            </form>
            <form class="flex items-center mx-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-2 text-white">
                ...
                <a data-modal-hide="{{ $book->id }}" href="" class="font-sans text-lg text-white hover:text gray-100">Remove</a>
            </form>
        </div>
    </div>
</div>
