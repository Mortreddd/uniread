<div class="min-h-full text-center bg-fixed bg-center bg-no-repeat bg-cover py-44" style="background-image: url('{{ asset($backgrounds) }}');" :backgrounds="$backgrounds" :heading="$heading" :description="$description">
