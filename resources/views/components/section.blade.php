<section class="w-full px-10 py-10 bg-fixed bg-center bg-no-repeat bg-cover h-fit" style="background-image: url('{{ asset('storage/backgrounds/BooksBackground.webp') }}');" :genre="$genre" :books="$books">
